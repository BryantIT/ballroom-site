        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-lg text-slate-400 max-w-md mb-10 leading-relaxed">
              ...
              syllabus patterns, earn achievements, and track your journey
              from Bronze to Open.
            </p>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              ...
              />
              <Image
                src="https://placehold.co/580x680/0f1629/c9a84c?text=Ballroom+Couple"
              ...
              <div className="absolute -top-5 -right-5 rounded-2xl border border-white/10 bg-navy-800/90 backdrop-blur-sm px-5 py-4 shadow-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-slate-400">Achievement unlocked</p>
